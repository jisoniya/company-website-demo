...
const techData = {
  ...
  Platforms: ['AWS', 'Azure', 'Google Cloud', 'Salesforce', 'Shopify', 'Magento'],
  Programming: ['JavaScript', 'Python', 'Java', 'Node.js', 'React', 'Next.js'],
};
  ...
  return (
    <Box sx={{...getBlackWrapperStyle(),textAlign:"center"}}>
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, mt: 4, gap: 2 }}>
        ...
        {/* Tech Cards */}
        <Grid container spacing={2} sx={{ backgroundColor: '#fff', borderRadius: 2, p: 2, flex: 1 ,color:"#000000"}}>
