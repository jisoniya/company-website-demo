...
const WeWorkWithSection = () => {
  ...
  const content = {
    ...
    Enterprises: {
      title: "Enterprises",
      description:
        " We empower enterprises with scalable IT and digital solutions designed to optimize operations and drive growth.",
      items: [
        "App Development",
        "QA & Testing",
        "Product Engineering",
    ...
    Agencies: {
      title: "Agencies",
      description:
        "We partner with agencies to deliver innovative IT solutions that enhance your offerings and sharpen your competitive edge.",
      items: [
            ...
            <Box sx={getLeftWrapper()}>
              <Box>
                ...
                <Typography sx={getSubPStyle()}>
                  We empower startups, enterprises, and agencies to boost their tech portfolio and improve profitability with tailored software engineering and IT solutions
                </Typography>
              </Box>
              {/* Buttons */}
