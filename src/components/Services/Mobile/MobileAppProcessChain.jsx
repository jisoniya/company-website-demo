...
const steps = [
  {
    title: 'Discovery & Strategy', desc: 'We deeply understand your vision, objectives, and market through consultations and analysis, defining a clear strategic roadmap for your app.'
  },
  {
    title: 'UI/UX Design & Prototyping', desc: 'Our experts craft intuitive UI/UX, creating wireframes and interactive prototypes. Visualize and refine your app’s look and feel before development begins.'
  },
  {
    title: 'Development & Engineering', desc: 'Skilled developers build your app with clean, scalable code for frontend and backend. We integrate APIs and follow best practices for native or cross-platform development.'
  },
  {
    title: 'Quality Assurance (QA) & Testing', desc: 'Our dedicated QA team performs rigorous functional, performance, and security testing. We ensure your app is bug-free, performs optimally, and delivers a seamless user experience.'
  },
  {
    title: 'Deployment & Launch', desc: 'After approval, we manage the entire app deployment process. This includes app store submissions, navigating approvals, and ensuring a smooth, successful launch.'
  },
  {
    title: 'Maintenance & Ongoing Support', desc: 'Our partnership continues post-launch with comprehensive maintenance. We provide bug fixes, performance monitoring, security updates, and enhancements to ensure your app evolves.'
  },
];
...
const MobileAppProcessChain = () => {
  ...
  return (
    ...
    <Container sx={containerStyle}>
      ...
      <Box sx={mobileAppProcessChainRow6}>
        {steps.map((step, idx) => (
          <Box key={idx} sx={{ position: 'relative', width: '100%' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', mb: 1 }}>
              ...
              {idx < steps.length - 1 && (
                <Box sx={mobileAppProcessChainConnector6}>
                  <DashedArrow />
                </Box>
              )}
            </Box>
