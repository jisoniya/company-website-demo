  ...
  return (
    <Box component="section" sx={{ ...getWhiteWrapperStyle() }}>
      <Container sx={containerStyle}>
        ...
        At Octagon Coders, a successful custom software solution is built on a foundation of clear strategy, meticulous execution, and continuous partnership.
        </Typography>
...
export default SoftwareProcessChain;
